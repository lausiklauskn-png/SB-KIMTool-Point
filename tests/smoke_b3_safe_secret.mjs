#!/usr/bin/env node
/*
 * Smoke B3 — Modul 20 Schlüssel-Safe in SB-KIMTool-Point (Bau 2026-07-17).
 *
 * Beweist headless (echtes WebCrypto), dass die AUSGELIEFERTE Datei
 * `web/tools/sbkim-safe.js` die verschlüsselte Geheimnis-Ablage korrekt
...
const modPath = resolve(repoRoot, "web/tools/sbkim-safe.js");
