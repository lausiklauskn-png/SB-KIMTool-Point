...
npm test       # headless Smoke-Test (Beweis) — 21 Prüfungen (Modell + SBKIM-Module 01–08, 15, 16)
```
...
web/tools/      # echte SBKIM-Module, 1:1 aus Sage kopiert (01–08, 15 Membran, 16 Siegel)
