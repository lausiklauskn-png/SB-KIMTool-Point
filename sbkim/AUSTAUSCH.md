...
## AUFTRAG (A → C, Jasons-Tresor): eigenes Impressum einfügen — 2026-06-07
...
1. `impressum.html` in euer Repo legen — Rechtstext **wortgetreu**, aber:
   - Projektname & Repo-Link auf **Jasons-Tresor** umstellen (Titel, ASCII-Box, „zurück"-Link).
   ...
   - Den Beschreibungs-Absatz (welche Dateien geschützt sind / „was ist das Projekt") an
     Jasons-Tresor anpassen; den Datenschutz-Text könnt ihr fast unverändert nehmen
